...
class FatJet(particle):
    ...
    def setUpBranches(self, wrappedOutputTree):
        ...
        wrappedOutputTree.branch("g{}_{}".format(self.particleType,"msoftdrop"),"{}".format("F"),lenVar="gn{}".format(self.particleType))
    ...
    def fillBranches(self,wrappedOutputTree):
        ...
        wrappedOutputTree.fillBranch("g{}_{}".format(self.particleType,"msoftdrop"),self.get_attributes("msoftdrop"))
        #for branch in FatJetBranches.values():

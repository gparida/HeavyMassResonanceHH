...
parser.add_argument('--inputFile1','-i1',help="Set of Files with no Isolation")
parser.add_argument('--inputFile2','-i2',help="Set of Files with default isolation")
parser.add_argument('--inputFile3','-i3',help="Set of Files with isolation correction applied")
...
ETLooseSB = makeHistogram("L","S/B",4, 34, 1)
ETLooseSSB = makeHistogram("L","S/sqrt(S+B)",4, 34, 1)
ETMediumSB = makeHistogram("M","S/B",2, 21, 1)
ETMediumSSB = makeHistogram("M","S/sqrt(S+B)",2, 21, 1)
ETTightSB = makeHistogram("T","S/B",3, 22, 1)
ETTightSSB = makeHistogram("T","S/sqrt(S+B)",3, 22, 1)

MTLooseSB = makeHistogram("L","S/B",4, 34, 1)
MTLooseSSB = makeHistogram("L","S/sqrt(S+B)",4, 34, 1)
MTMediumSB = makeHistogram("M","S/B",2, 21, 1)
MTMediumSSB = makeHistogram("M","S/sqrt(S+B)",2, 21, 1)
MTTightSB = makeHistogram("T","S/B",3, 22, 1)
MTTightSSB = makeHistogram("T","S/sqrt(S+B)",3, 22, 1)

TTLooseSB = makeHistogram("L","S/B",4, 34, 1)
TTLooseSSB = makeHistogram("L","S/sqrt(S+B)",4, 34, 1)
TTMediumSB = makeHistogram("M","S/B",2, 21, 1)
TTMediumSSB = makeHistogram("M","S/sqrt(S+B)",2, 21, 1)
TTTightSB = makeHistogram("T","S/B",3, 22, 1)
TTTightSSB = makeHistogram("T","S/sqrt(S+B)",3, 22, 1)
...
legET.AddEntry(ETLooseSB,"L","ep")
legET.AddEntry(ETMediumSB,"M","ep")
legET.AddEntry(ETTightSB,"T","ep")
...
legET2.AddEntry(ETLooseSSB,"L","ep")
legET2.AddEntry(ETMediumSSB,"M","ep")
legET2.AddEntry(ETTightSSB,"T","ep")
...
legMT.AddEntry(MTLooseSB,"L","ep")
legMT.AddEntry(MTMediumSB,"M","ep")
legMT.AddEntry(MTTightSB,"T","ep")
...
legMT2.AddEntry(MTLooseSSB,"L","ep")
legMT2.AddEntry(MTMediumSSB,"M","ep")
legMT2.AddEntry(MTTightSSB,"T","ep")
...
legTT.AddEntry(TTLooseSB,"L","ep")
legTT.AddEntry(TTMediumSB,"M","ep")
legTT.AddEntry(TTTightSB,"T","ep")
...
legTT2.AddEntry(TTLooseSSB,"L","ep")
legTT2.AddEntry(TTMediumSSB,"M","ep")
legTT2.AddEntry(TTTightSSB,"T","ep")

...
#                    #continue                    
            ...
            if ((boostedtauMatched(tree_bbtt,Tau_gen_v1)[0] and boostedtauMatched(tree_bbtt,Tau_gen_v2)[0]) and (boostedtauMatched(tree_bbtt,Tau_gen_v1)[1] != boostedtauMatched(tree_bbtt,Tau_gen_v2)[1])):
                if (((tree_bbtt.boostedTau_idMVAoldDM2017v2[boostedtauMatched(tree_bbtt,Tau_gen_v1)[1]] & btau_id) == btau_id) or ((tree_bbtt.boostedTau_idMVAoldDM2017v2[boostedtauMatched(tree_bbtt,Tau_gen_v2)[1]] & btau_id) == btau_id)):

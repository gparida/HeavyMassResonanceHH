...
#
    ...
    #############################Saving The Plots####################################
        ...
        theCanvas.SaveAs('ETPlots/CorrWht/'+variableAxisTitleDictionary[variable]+'_'+args.year+'.pdf')
        ...
        ShapeCanvas.SaveAs('ETPlots/CorrWht/'+ "Normalized" +variableAxisTitleDictionary[variable]+'_'+args.year+'.pdf')
